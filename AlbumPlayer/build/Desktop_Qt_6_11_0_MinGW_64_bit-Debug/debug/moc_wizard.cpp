...
void Wizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sigProjSetting((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Wizard::*)(const QString & , const QString & )>(_a, &Wizard::sigProjSetting, 0))
            return;
    }
}
...
// SIGNAL 0
void Wizard::sigProjSetting(const QString & _t1, const QString & _t2)
{
